...
print('-' * 10)
print("Michigam's abbreviation is: ", states['Michigan'])
...
print('-' * 10)
for sate, abbrev in list(states.items()):
    print(f"{state} state is abbreviated {abbrev}")
    print(f"and has city {cities[abbrev]}")

print('-' * 10)
# com segurança, obtenha uma sigla de um um estado que pode não estar ali
